    ...
    return (
        <div className="flex flex-col w-56">
            <div className="relative h-56">
                {(expanded || !props.image) && props.details && <div className="absolute top-0 left-0 w-full h-full bg-stone-100 opacity-80">
            ...
            <div className="justify-self-end pt-2 w-full h-10 flex flex-row items-center justify-between">
                {props.image && <button className="h-6 w-6 flex-none ml-2" onClick={(e) => onClick(e, ()=>setExpanded(!expanded))}>
                    <Info/>
                </button>}
